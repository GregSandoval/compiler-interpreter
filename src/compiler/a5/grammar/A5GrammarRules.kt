...
object A5GrammarRules {
    fun build() {
        ...
        Classid()
                .on(IdentifierToken::class.java)
                .useRHS(IdentifierToken.Companion::sentinel)
        Varspec()
                .on(IdentifierToken::class.java)
        ...
        KKint()
                .on(LeftBracket::class.java)
                .useRHS(::LeftBracket, IntegerToken.Companion::sentinel, ::RightBracket)
        Deref_id()
                .on(Asterisk::class.java)
                .useRHS(::Deref, IdentifierToken.Companion::sentinel)
        Deref()
                .on(Asterisk::class.java)
                .useRHS(::Asterisk)
        Varinit()
        ...
        Class_ctrl()
                .on(Colon::class.java)
                .useRHS(::Colon, IdentifierToken.Companion::sentinel)
        Interfaces()
                .on(Plus::class.java)
        ...
        Mddecls()
                ...
                .on(
                        SemiColon::class.java,
                        VarKeywordToken::class.java,  //FunctionKeywordToken.class, Mistake?
                        RightBrace::class.java
                )
                .useRHS()
        Mdheader()
        ...
        StasgnOrFcall()
                ...
                .on(IdentifierToken::class.java)
                .useRHS(IdentifierToken.Companion::sentinel, ::StasgnOrFcall_Suffix)
        ...
        LvalOrFcall()
                ...
                .useRHS(::Deref_id)
                .on(IdentifierToken::class.java)
                .useRHS(IdentifierToken.Companion::sentinel, ::LvalOrFcall_Suffix)
        LvalOrFcall_Suffix()
                .on(LeftBracket::class.java)
                .useRHS(::Lval_Suffix)
                .on(LeftParen::class.java)
        ...
        BaseLiteral()
                ...
                .useRHS(IntegerToken.Companion::sentinel)
                .on(FloatToken::class.java)
                .useRHS(FloatToken.Companion::sentinel)
                .on(StringToken::class.java)
                .useRHS(StringToken.Companion::sentinel)
        Addrof_id()
                .on(Ampersand::class.java)
                .useRHS(::Ampersand, IdentifierToken.Companion::sentinel)
        Oprel()
